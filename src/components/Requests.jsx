...
const Requests = () => {
  ...
  return (
    <div className="mt-20 flex flex-col items-center my-10 px-2 sm:px-4">
      ...
      {requests.length === 0 ? (
        <div className="flex flex-col items-center bg-base-300 p-6 sm:p-8 rounded-2xl shadow-xl w-full max-w-md text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 w-full max-w-6xl">
          {requests.map(({ _id, fromUserId }) => {
            ...
            return (
              <div
                key={_id}
                className="group bg-white dark:bg-base-200 border border-gray-200 dark:border-gray-700 rounded-2xl shadow-xl hover:shadow-2xl hover:scale-[1.03] transition-all cursor-pointer flex flex-col items-center p-4 sm:p-6 relative overflow-hidden min-h-[320px] sm:min-h-[340px] w-full"
