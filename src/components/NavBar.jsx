...
const NavBar = () => {
  ...
  return (
    <nav className="navbar fixed top-0 left-0 right-0 z-20 glass py-2 px-2 md:px-8 shadow-lg border-b border-base-200">
      ...
      {user && (
        <>
          ...
          {/* Home button (new, next to burger) */}
          <Link
            to="/"
          ...
          <div className="relative">
            ...
            {navOpen && (
              <div ref={navMenuRef} className="absolute right-0 top-12 w-56 bg-base-100 rounded-xl shadow-lg border border-base-200 z-30 animate-fade-in flex flex-col p-4 gap-2">
          ...
          <div className="dropdown dropdown-end">
            ...
            <ul tabIndex={0} className="menu menu-sm dropdown-content bg-base-100 rounded-box z-[1] mt-3 w-44 p-2 shadow-lg border border-base-200">
              <li>
