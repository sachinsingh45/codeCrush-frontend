      ...
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-center">
        ...
        <div className="flex flex-col items-center md:items-start space-y-4 md:space-y-0">
          <div className="flex items-center space-x-3">
            ...
            <p className="text-xl font-bold text-gray-200">CodeCrush</p>
          </div>
        ...
        <div className="flex space-x-6 mt-4 md:mt-0">
          <a href="#" aria-label="Facebook" className="text-gray-400 hover:text-indigo-500 transition-colors">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
          ...
          <a href="#" aria-label="Twitter" className="text-gray-400 hover:text-indigo-500 transition-colors">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
          ...
          <a href="#" aria-label="Instagram" className="text-gray-400 hover:text-indigo-500 transition-colors">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
